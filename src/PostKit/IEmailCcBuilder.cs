...
/// <summary>
/// Provides additional configuration for carbon-copy email recipients.
/// </summary>
public interface IEmailCcBuilder : IEmailBuilder
{
    /// <summary>
    /// Adds another carbon-copy recipient by address.
    /// </summary>
    ...
    /// <summary>
    /// Adds another carbon-copy recipient by name and address.
    /// </summary>
    ...
    /// <summary>
    /// Adds another carbon-copy recipient using a <see cref="MailboxAddress"/>.
    /// </summary>
    ...
    /// <summary>
    /// Adds multiple carbon-copy recipients by address.
    /// </summary>
