...
{
    internal BulkEmailValidationError(BulkEmailJob acceptedJob, JsonElement unprocessableContent) : base("The Postmark Bulk API accepted the bulk email request but reported unprocessable messages.")
    {
