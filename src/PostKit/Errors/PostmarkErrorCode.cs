...
public enum PostmarkErrorCode
{
    ...
    /// <summary>Sender Signature not found. You're trying to send an email with a From address that doesn't have a sender signature. Refer to your existing list of Sender Signatures or add a new one.</summary>
    SenderSignatureNotFound = 400,

    /// <summary>Sender signature isn't confirmed. You're trying to send an email with a From address that doesn't have a confirmed sender signature. You can resend the confirmation email on the Sender Signatures page.</summary>
    ...
    /// <summary>Inactive recipient. You tried to send an email to a recipient that has been marked as inactive.</summary>
    ...
    /// <summary>Account is Pending. The account associated with the sent request is still pending approval.</summary>
    AccountIsPending = 412,

    /// <summary>Account May Not Send. The account associated with the sent request is not approved for sending.</summary>
    ...
    /// <summary>Sender Signature wasn't found by ID. We couldn't locate the Sender Signature you're trying to manage from the ID passed in.</summary>
    ...
    /// <summary>Missing the required field for Sender Signature. When creating a Sender Signature, you must supply a value for Name and FromEmail.</summary>
    ...
    /// <summary>Cannot bypass a blocked inbound message. Please contact support.</summary>
    CannotBypassBlockedInboundMessage = 702,

    /// <summary>Cannot retry a failed inbound message. Please contact support.</summary>
    ...
    /// <summary>Missing a required Template field. A required field is missing from the body of the POST request.</summary>
    MissingRequiredTemplateField = 1120,

    /// <summary>A template field is too large. One of the values of the request's body exceeds size restrictions.</summary>
    ...
    /// <summary>Invalid field in the request body. A field is included in the request that is not allowed or ignored.</summary>
    ...
    /// <summary>Message Stream Name is too long. Limit the Name to 100 characters.</summary>
    ...
    /// <summary>Message Stream Description is too long. Limit it to 1000 characters.</summary>
    ...
    /// <summary>Message Stream was not found on this server. Ensure the provided ID exists.</summary>
    MessageStreamNotFoundOnServer = 1235,

    /// <summary>Sending is not supported on this Message Stream. Only supported for certain types.</summary>
