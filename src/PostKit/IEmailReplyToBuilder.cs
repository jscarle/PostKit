...
/// <summary>
/// Provides additional configuration for reply-to email recipients.
/// </summary>
public interface IEmailReplyToBuilder : IEmailBuilder
{
    /// <summary>
    /// Adds another reply-to recipient by address.
    /// </summary>
    ...
    /// <summary>
    /// Adds another reply-to recipient by name and address.
    /// </summary>
    ...
    /// <summary>
    /// Adds another reply-to recipient using a <see cref="MailboxAddress"/>.
    /// </summary>
    ...
    /// <summary>
    /// Adds multiple reply-to recipients by address.
    /// </summary>
