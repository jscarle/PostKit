...
/// <summary>Represents an outbound-message spam complaint reported by Postmark.</summary>
public sealed record SpamComplaintWebhookMessage : OutboundWebhookMessage
{
    /// <summary>Gets the Postmark complaint identifier.</summary>
    [JsonPropertyName("ID")]
    public required long Id { [UsedImplicitly] get; init; }

    /// <summary>Gets the Postmark complaint classification.</summary>
    [JsonPropertyName("Type")]
    public required string Type { [UsedImplicitly] get; init; }

    /// <summary>Gets the numeric Postmark complaint classification.</summary>
    [JsonPropertyName("TypeCode")]
    public required int TypeCode { [UsedImplicitly] get; init; }

    /// <summary>Gets the human-readable complaint type name.</summary>
    ...
    /// <summary>Gets the complaint description.</summary>
    [JsonPropertyName("Description")]
    public required string Description { [UsedImplicitly] get; init; }

    /// <summary>Gets the complaint details.</summary>
    [JsonPropertyName("Details")]
    public required string Details { [UsedImplicitly] get; init; }

    /// <summary>Gets the recipient address associated with the complaint.</summary>
    ...
    /// <summary>Gets the complaint timestamp.</summary>
    [JsonPropertyName("BouncedAt")]
    public required DateTimeOffset BouncedAt { [UsedImplicitly] get; init; }

    /// <summary>Gets whether a raw complaint dump is available.</summary>
    ...
    /// <summary>Gets the full abuse report when the webhook includes message content.</summary>
