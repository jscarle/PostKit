...
/// <summary>Represents a Postmark sender domain.</summary>
public sealed record PostmarkDomain
{
    internal PostmarkDomain(long id, string name, bool spfVerified, string? spfHost, string? spfTextValue, bool dkimVerified, bool weakDkim, string? dkimHost, string? dkimTextValue, string? dkimPendingHost, string? dkimPendingTextValue,
        string? dkimRevokedHost, string? dkimRevokedTextValue, bool? safeToRemoveRevokedKeyFromDns, string? dkimUpdateStatus, string? returnPathDomain, bool returnPathDomainVerified, string? returnPathDomainCNameValue)
    {
        Id = id;
        Name = name;
