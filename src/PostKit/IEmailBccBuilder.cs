...
/// <summary>
/// Provides additional configuration for blind carbon-copy email recipients.
/// </summary>
public interface IEmailBccBuilder : IEmailBuilder
{
    /// <summary>
    /// Adds another blind carbon-copy recipient by address.
    /// </summary>
    ...
    /// <summary>
    /// Adds another blind carbon-copy recipient by name and address.
    /// </summary>
    ...
    /// <summary>
    /// Adds another blind carbon-copy recipient using a <see cref="MailboxAddress"/>.
    /// </summary>
    ...
    /// <summary>
    /// Adds multiple blind carbon-copy recipients by address.
    /// </summary>
