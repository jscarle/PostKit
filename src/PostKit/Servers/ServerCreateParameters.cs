...
/// <summary>Represents parameters for creating a Postmark server.</summary>
public sealed record ServerCreateParameters
{
    ...
    /// <summary>Gets the server delivery type. Postmark does not allow changing this after creation.</summary>
