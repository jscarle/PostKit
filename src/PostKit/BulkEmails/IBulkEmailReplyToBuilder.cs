...
/// <summary>Provides additional configuration for bulk email reply-to recipients.</summary>
public interface IBulkEmailReplyToBuilder : IBulkEmailBuilder
{
    /// <summary>Adds another reply-to recipient by address.</summary>
    /// <param name="address">The reply-to email address.</param>
    /// <returns>The builder instance for fluent chaining.</returns>
    IBulkEmailReplyToBuilder AlsoReplyTo(string address);
    ...
    /// <param name="address">The reply-to email address.</param>
    /// <returns>The builder instance for fluent chaining.</returns>
    IBulkEmailReplyToBuilder AlsoReplyTo(string? name, string address);
    ...
    /// <returns>The builder instance for fluent chaining.</returns>
    IBulkEmailReplyToBuilder AlsoReplyTo(MailboxAddress mailboxAddress);

    /// <summary>Adds multiple reply-to recipients by address.</summary>
    /// <param name="addresses">The reply-to email addresses.</param>
    /// <returns>The builder instance for fluent chaining.</returns>
    IBulkEmailReplyToBuilder AlsoReplyTo(IEnumerable<string> addresses);
    ...
    /// <returns>The builder instance for fluent chaining.</returns>
    IBulkEmailReplyToBuilder AlsoReplyTo(IEnumerable<MailboxAddress> mailboxAddresses);

    /// <summary>Adds multiple reply-to recipients using mailbox addresses.</summary>
    /// <param name="mailboxAddresses">The reply-to mailbox addresses.</param>
    /// <returns>The builder instance for fluent chaining.</returns>
    IBulkEmailReplyToBuilder AlsoReplyTo(IList<MailboxAddress> mailboxAddresses);
}
