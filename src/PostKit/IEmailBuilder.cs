...
/// <summary>Defines a fluent interface for constructing <see cref="Email"/> messages.</summary>
[SuppressMessage("Naming", "CA1716: Identifiers should not match keywords", Justification = "Emails have to go to someone!")]
public interface IEmailBuilder
{
    /// <summary>Finalizes the builder and produces an <see cref="Email"/> instance.</summary>
    ...
    /// <summary>Configures link tracking for the email.</summary>
    ...
    /// <summary>Specifies the message stream for the email.</summary>
    ...
    /// <summary>Specifies the message stream for the email using an identifier.</summary>
