...
public class PostKitClientBulkResponseTests
{
    ...
    [Fact]
    public async Task SendBulkEmailAsync_WithCustomAdditionalProperties_PreservesThemOnSuccess()
    {
        const string responseJson = """
                                    {
                                      "Id": "c42d4a19-b645-4cdd-9859-08d8f24b649a",
    ...
    [Fact]
    public async Task SendBulkEmailAsync_WithUnprocessableContent_ReturnsValidationFailureWithAcceptedJob()
    {
        const string responseJson = """
                                    {
                                      "Id": "c42d4a19-b645-4cdd-9859-08d8f24b649a",
        ...
        Assert.Equal("bad@postkit.com", validationError.UnprocessableContent.GetProperty("Messages")[0]
            .GetProperty("To")
            .GetString());
        Assert.Equal("Invalid recipient", validationError.UnprocessableContent.GetProperty("Messages")[0]
            .GetProperty("Error")
            .GetString());
    }
